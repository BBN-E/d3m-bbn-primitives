...
class BBNMLPClassifier(SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    ...
    metadata = metadata_module.PrimitiveMetadata({
        ...
        'source': {
            ...
            'uris': [
                'https://gitlab.datadrivendiscovery.org/BBN/d3m-bbn-primitives/blob/{git_commit}/bbn_primitives/sklearn_wrap/mlp_classifier.py'.format(
        ...
        'python_path': 'd3m.primitives.bbn.sklearn_wrap.BBNMLPClassifier', #'d3m.primitives.classification.mlp_classifier.BBN',
