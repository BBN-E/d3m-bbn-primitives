...
_logger = logging.getLogger('d3m.primitives.bbn.time_series.AudioReader')
...
class AudioReader(FeaturizationTransformerPrimitiveBase[Inputs, Outputs, Hyperparams]):
    ...
    metadata = metadata_module.PrimitiveMetadata({
        ...
        'source': {
            ...
            'uris': [
                'https://gitlab.datadrivendiscovery.org/BBN/d3m-bbn-primitives/blob/{git_commit}/bbn_primitives/time_series/audio_reader.py'.format(
