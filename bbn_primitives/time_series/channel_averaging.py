...
_logger = logging.getLogger('d3m.primitives.data_preprocessing.channel_averager.BBN')
...
class ChannelAverager(FeaturizationTransformerPrimitiveBase[Inputs, Outputs, Hyperparams]):
    ...
    metadata = metadata_module.PrimitiveMetadata({
        ...
        'python_path': 'd3m.primitives.data_preprocessing.channel_averager.BBN', #'d3m.primitives.bbn.time_series.ChannelAverager', #'d3m.primitives.data_preprocessing.channel_averager.BBN',
