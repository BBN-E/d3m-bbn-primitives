...
_logger = logging.getLogger('d3m.primitives.clustering.cluster_curve_fitting_kmeans.BBN')
...
class ClusterCurveFittingKMeans(UnsupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    ...
    metadata = metadata_module.PrimitiveMetadata({
        ...
        'python_path': 'd3m.primitives.clustering.cluster_curve_fitting_kmeans.BBN',#'d3m.primitives.bbn.time_series.ClusterCurveFittingKMeans', #'d3m.primitives.clustering.cluster_curve_fitting_kmeans.BBN',
