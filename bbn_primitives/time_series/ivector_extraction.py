...
_logger = logging.getLogger('d3m.primitives.bbn.time_series.IvectorExtractor')
...
class IVectorExtractor(UnsupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    ...
    metadata = metadata_module.PrimitiveMetadata({
        ...
        'source': {
            ...
            'uris': [
                'https://gitlab.datadrivendiscovery.org/BBN/d3m-bbn-primitives/blob/{git_commit}/bbn_primitives/time_series/ivector_extraction.py'.format(
