...
_logger = logging.getLogger('d3m.primitives.data_transformation.i_vector_extractor.BBN')
...
class IVectorExtractor(UnsupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    ...
    metadata = metadata_module.PrimitiveMetadata({
        ...
        'python_path': 'd3m.primitives.data_transformation.i_vector_extractor.BBN', #'d3m.primitives.bbn.time_series.IVectorExtractor', #'d3m.primitives.data_transformation.ivector_extractor.BBN',
