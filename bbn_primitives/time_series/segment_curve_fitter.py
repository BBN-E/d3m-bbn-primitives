...
_logger = logging.getLogger('d3m.primitives.data_transformation.segment_curve_fitter.BBN')
...
class SegmentCurveFitter(FeaturizationTransformerPrimitiveBase[Inputs, Outputs, Hyperparams]):
    ...
    metadata = metadata_module.PrimitiveMetadata({
        ...
        'source': {
            ...
            'uris': [
                'https://github.com/BBN-E/d3m-bbn-primitives/blob/{git_commit}/bbn_primitives/time_series/segment_curve_fitter.py'.format(
        ...
        'python_path': 'd3m.primitives.data_transformation.segment_curve_fitter.BBN', #'d3m.primitives.bbn.time_series.SegmentCurveFitter', #'d3m.primitives.data_transformation.segment_curve_fitter.BBN',
