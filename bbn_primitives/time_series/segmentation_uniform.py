...
_logger = logging.getLogger('d3m.primitives.time_series_segmentation.uniform_segmentation.BBN')
...
class UniformSegmentation(FeaturizationTransformerPrimitiveBase[Inputs, Outputs, Hyperparams]):
    ...
    metadata = metadata_module.PrimitiveMetadata({
        ...
        'python_path': 'd3m.primitives.time_series_segmentation.uniform_segmentation.BBN',#'d3m.primitives.bbn.time_series.UniformSegmentation', #'d3m.primitives.time_series_segmentation.uniform_segmentation.BBN',
