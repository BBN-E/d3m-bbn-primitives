...
_logger = logging.getLogger('d3m.primitives.time_series_segmentation.signal_framer.BBN')
...
class SignalFramer(FeaturizationTransformerPrimitiveBase[Inputs, Outputs, Hyperparams]):
    ...
    metadata = metadata_module.PrimitiveMetadata({
        ...
        'python_path': 'd3m.primitives.time_series_segmentation.signal_framer.BBN',#'d3m.primitives.bbn.time_series.SignalFramer', #'d3m.primitives.time_series_segmentation.signal_framer.BBN',
