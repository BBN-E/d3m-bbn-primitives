...
_logger = logging.getLogger('d3m.primitives.feature_extraction.signal_mfcc.BBN')
...
class SignalMFCC(FeaturizationTransformerPrimitiveBase[Inputs, Outputs, Hyperparams]):
    ...
    metadata = metadata_module.PrimitiveMetadata({
        ...
        'python_path': 'd3m.primitives.feature_extraction.signal_mfcc.BBN', #'d3m.primitives.bbn.time_series.SignalMFCC', #'d3m.primitives.feature_extraction.signal_mfcc.BBN',
