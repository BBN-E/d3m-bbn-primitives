...
_logger = logging.getLogger('d3m.primitives.feature_extraction.tfidf_vectorizer.BBN')
...
class BBNTfidfTransformer(UnsupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    ...
    metadata = metadata_module.PrimitiveMetadata({
        ...
        'python_path': 'd3m.primitives.feature_extraction.tfidf_vectorizer.BBN', #'d3m.primitives.bbn.time_series.BBNTfidfTransformer', #'d3m.primitives.feature_extraction.tfidf_transformer.BBN',
